...
MODEL                   = mdlref_dynamics
MODULES                 = mdlref_dynamics.c mdlref_dynamics_capi.c 
MAKEFILE                = mdlref_dynamics.mk
MATLAB_ROOT             = E:\Matlab 2015a
ALT_MATLAB_ROOT         = E:\MATLAB~1
MATLAB_BIN              = E:\Matlab 2015a\bin
ALT_MATLAB_BIN          = E:\MATLAB~1\bin
MASTER_ANCHOR_DIR       = 
START_DIR               = C:\Users\flying\Desktop\Hexarotor
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 2
...
GEN_SAMPLE_MAIN         = 0
TARGET_LANG_EXT         = c
MEX_OPT_FILE            = -f "C:\Users\flying\AppData\Roaming\MathWorks\MATLAB\R2015a\mex_C_win64.xml"
COMPUTER                = PCWIN64
...
MODELLIB                  = mdlref_dynamicslib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = mdlref_dynamics_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\sim\mdlref_dynamics
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\help\toolbox\simulink\ug\examples\analysis
