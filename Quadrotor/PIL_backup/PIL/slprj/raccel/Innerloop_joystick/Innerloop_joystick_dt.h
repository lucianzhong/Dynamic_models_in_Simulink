...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . odxbyhfnjy
) , 0 , 0 , 29 } , { ( char_T * ) ( & rtDW . p1y0lpolue . LoggedData ) , 11 ,
0 , 9 } , { ( char_T * ) ( & rtDW . mnimyxb55z ) , 10 , 0 , 2 } } ; static
DataTypeTransitionTable rtBTransTable = { 3U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
Integrator_IC ) , 0 , 0 , 40 } } ; static DataTypeTransitionTable
